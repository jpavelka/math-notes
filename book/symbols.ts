...
export const symbols: SymbolEntry[] = [
  // ── Sets & Logic ──────────────────────────────────────────────────────────
  { latex: '\\{\\cdots\\}', description: 'set notation: $\\{0,1\\}$ is the two-element set containing 0 and 1', category: 'Sets & Logic', aliases: ['{', '}', 'hahaha'] },
  { latex: '\\{x : P(x)\\}', description: 'conditional set: set of all $x$ satisfying condition $P(x)$; e.g. $\\{n \\in \\Z : 5 \\leq n \\leq 10\\} = \\{5,6,7,8,9,10\\}$', category: 'Sets & Logic', aliases: ['conditional set', 'set builder'] },
  { latex: '\\in', description: 'set membership: $x\\in S$ means $x$ is an element of set $S$', category: 'Sets & Logic', aliases: ['in', 'element', '∈'] },
  { latex: '\\not\\in', description: 'not a member of the set: $x\\not\\in S$ means $x$ is not an element of set $S$', category: 'Sets & Logic', aliases: ['∉', 'notin', 'not in'] },
  { latex: '\\subseteq', description: 'subset: $S \\subseteq T$ means $S$ is a subset of $T$ (i.e. every element of $S$ is also in $T$)', category: 'Sets & Logic', aliases: ['subseteq', 'subset'] },
  { latex: '\\cup', description: 'set union: $S \\cup T=\{x: x\\in S\\text{ or } x\\in T\}$, the union of sets $S$ and $T$; $\\bigcup_{i} S_i$ for a collection of sets', category: 'Sets & Logic', aliases: ['cup', 'union'] },
  { latex: '\\cap', description: 'set intersection: $S \\cup T=\{x: x\\in S\\text{ and } x\\in T\}$, the intersection of sets $S$ and $T$; $\\bigcap_{i} S_i$ for a collection of sets', category: 'Sets & Logic', aliases: ['cap', 'intersection'] },
  { latex: '\\setminus', description: 'set difference: $S \\setminus T=\{x: x\\in S \\text{ and } x\\not\\in T\}$', category: 'Sets & Logic', aliases: ['setminus', 'difference'] },
  { latex: '|S|', description: 'set cardinality: $|S|$ is the number of elements in set $S$', category: 'Sets & Logic', aliases: ['size', 'cardinality'] },
  ...
  // ── Notation ──────────────────────────────────────────────────────────────
  { latex: '\\floor{x}', description: 'floor of $x$: round down to the nearest integer; e.g. $\\floor{1.7} = 1$', category: 'Notation', aliases: ['floor'] },
  { latex: '\\ceil{x}', description: 'ceiling of $x$: round up to the nearest integer; e.g. $\\ceil{1.3} = 2$', category: 'Notation', aliases: ['ceiling', 'ceil'] },
  { latex: '\\conv(v^1, \\ldots, v^k)', description: 'convex hull: the set of all convex combinations of the points $v^1,\\ldots,v^k$; equivalently, the smallest convex set containing them', category: 'Notation', aliases: ['convex hull', 'conv', 'hull'] },
  { latex: '\\cone(r^1, \\ldots, r^\\ell)', description: 'conical hull: the set of all non-negative combinations $\\sum_j \\mu_j r^j$ (with $\\mu_j \\geq 0$) of the rays $r^1,\\ldots,r^\\ell$', category: 'Notation', aliases: ['conical hull', 'cone', 'conic hull', 'nonnegative combination'] },
];
